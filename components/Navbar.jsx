    ...
    <nav className="bg-blue-700 border-b border-blue-500">
        ...
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
            <button
              ...
              aria-expanded="false"
              onClick={()=>isMobileMenuOpen((prev)=>!prev)}
            >
      ...
      {isMobileMenuOpen && (  <div id="mobile-menu">
        <div className="space-y-1 px-2 pb-3 pt-2">
          ...
          <Link
            href="/properties"
            className={`${pathname==='/properties'?'bg-black':''} text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
          >
            Properties
          </Link>
          {isLoggedIn && (<Link
            href="/properties/add"
            className={`${pathname==='/properties/add'?'bg-black':''} text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium`}

          >
            Add Property
          </Link>
)}
          {!isLoggedIn && (<button className="flex items-center text-white bg-gray-700 hover:bg-gray-900 rounded-md px-3 py-2 my-4">
            <span>Login or Register</span>
          </button>)}
